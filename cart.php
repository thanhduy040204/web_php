...
<div class="container mt-5">
    ...
    <table class="table table-bordered align-middle text-center">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td colspan="2" class="text-danger fw-bold"><?php echo number_format($total); ?> VND</td>
        </tr>
      </tbody>
    </table>

    <div class="d-flex justify-content-between flex-wrap">
      <a href="index.php" class="btn btn-secondary mb-2">⬅ Tiếp tục mua sắm</a>
      <div class="mb-2">
  ...
  <?php else: ?>
    ...
    <a href="index.php" class="btn btn-success">Mua ngay</a>
  <?php endif; ?>
</div>
